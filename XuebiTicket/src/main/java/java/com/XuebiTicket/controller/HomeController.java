...
public class HomeController {
	...
	@RequestMapping(value = "cinema/cinemaList", method = RequestMethod.GET)
	@ResponseBody
	@JsonView(JsonModule.GetCinemaListModule.class)
	public Object getCinemaList(@RequestParam(value = "movieId", required = false) Integer id) {
		return jsonService.getCinemaListByJson(id);
	}
	@RequestMapping(value = "cinema/info", method = RequestMethod.GET)
	@ResponseBody
	@JsonView(JsonModule.CreateOrderModule.class)
	public Object getCinemaInfo(String name) {
